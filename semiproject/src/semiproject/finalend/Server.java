...
public class Server extends Thread{
   ...
   static HashMap<String, String> myCounterpart = new HashMap<String, String>(); 
   // 게임할 상대를 저장. 키값은 내 ip, val값은 상대 닉네임 저장. gameList사용할 시myCounterpart.get(ip)로 상대를 String으로 받아 gameList.<상대>로 ObjectOutputStream 전송 통로 연결 
      ...
      static void whisper(String address, String ip, String msg2) throws Exception{
         try {
            ...
            if(address.equals(ip)) { 
               whisperchat += "(귓속말을 보냄)" + nickname + "에게>>" + msg2;
            }else {
   ...
   static class Game{
      ...
      //120번
      static void trying(String myCounter, String ip) {
